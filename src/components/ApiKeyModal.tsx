...
export default function PasswordGate({ onUnlock, error }: PasswordGateProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F1B2D]">
      <div className="w-full max-w-sm px-6">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <div>
            <div className="text-white font-bold text-xl">FemInsight</div>
            <div className="text-white/40 text-xs">Synthetic Focus Group</div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                autoFocus
                className={`w-full bg-white/[0.05] border rounded-xl px-4 py-3 pr-12 text-white placeholder-white/25 text-sm focus:outline-none transition-all ${
                  error
                    ? 'border-red-500/60 focus:border-red-500/80'
                    : 'border-white/[0.10] focus:border-[#7C3AED]/60'
                }`}
              />
              <button
                type="button"
